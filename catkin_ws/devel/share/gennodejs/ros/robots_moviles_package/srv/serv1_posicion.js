...
class serv1_posicionRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type serv1_posicionRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type serv1_posicionRequest
    let len;
    let data = new serv1_posicionRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new serv1_posicionRequest(null);
...
class serv1_posicionResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type serv1_posicionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type serv1_posicionResponse
    let len;
    let data = new serv1_posicionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robots_moviles_package/serv1_posicionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new serv1_posicionResponse(null);
...
module.exports = {
  Request: serv1_posicionRequest,
  Response: serv1_posicionResponse,
  md5sum() { return '049d75b744ba6418566a32f18f43c69c'; },
  datatype() { return 'robots_moviles_package/serv1_posicion'; }
};
